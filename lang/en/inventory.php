...
$string['inventory:view'] = 'View inventory content';
...
$string['failureandreservationintro'] = 'Find below the information of the device that you will need';
...
$string['reportfailure'] = 'Report a failure';
