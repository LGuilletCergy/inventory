 ...
 *
 * File : settings.php
 * Inventory module admin settings and default
 *
 */
...
if ($ADMIN->fulltree) {
    ...
    // General settings.
    $settings->add(new admin_setting_configmultiselect('inventory/displayoptions',
        get_string('displayoptions', 'inventory'), get_string('configdisplayoptions', 'inventory'),
